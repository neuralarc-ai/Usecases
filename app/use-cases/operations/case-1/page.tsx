  ...
  return (
    <CaseDetail
      ...
      businessChallenge={{
        ...
        challenges: [
          "Trade reconciliation involves matching 10,000+ daily trades across multiple systems, taking 8-12 hours daily",
          "Manual processes lead to settlement failures (0.5-1% of trades), regulatory fines ($50K-$200K per incident), and operational losses ($2M+ annually)",
          "Client dissatisfaction, high operational risk, and extensive manual investigation (4-6 hours per break)",
          "Trade reconciliation complexity includes multiple trading platforms, different asset classes (equities, fixed income, derivatives, FX), various counterparties, time zone differences, corporate actions, and settlement instructions"
        ]
      }}
      toolsUsed={[
        {
      ...
      comparisonTable={[
        {
          capability: "Multi-System Trade Matching",
        ...
        {
          capability: "AI-Powered Break Resolution",
          popularTools: "Airtable, Notion, Coda",
          helium: true
        },
        {
          capability: "Real-Time Exception Detection",
          popularTools: "Manual investigation",
          helium: true
        },
        {
