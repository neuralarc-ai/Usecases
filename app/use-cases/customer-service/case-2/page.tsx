  ...
  return (
    <CaseDetail
      ...
      businessChallenge={{
        ...
        challenges: [
          "Policy inquiries require agent assistance, consuming 35% of call center capacity. Customers wait 6-8 minutes for simple information",
          "$1.5M annual call center costs for policy inquiries and customer frustration",
          "Agent time wasted on simple questions, limited self-service options, and poor mobile experience",
          "Simple information requests include coverage details, payment status, policy documents, beneficiary information, and renewal dates"
        ]
      }}
      toolsUsed={[
        {
      ...
      comparisonTable={[
        {
          capability: "AI-Powered Information Retrieval",
        ...
        },
        {
          ...
          popularTools: "Limited self-service",
          helium: true
        },
        {
          capability: "Instant Access",
          popularTools: "6-8 minute wait times",
          helium: true
        },
        {
          capability: "Mobile-Optimized Experience",
          popularTools: "Poor mobile experience",
          helium: true
        }
      ]}
      heliumSolution={{
