  ...
  return (
    <CaseDetail
      ...
      businessChallenge={{
        ...
        description: "Insurance carriers lack real-time competitive intelligence with quarterly market analysis (outdated), limited competitive pricing visibility, reactive product development, missed market opportunities, and $10M+ in lost revenue. Market intelligence gaps include competitor pricing, product features, market trends, customer preferences, and regulatory changes."
      }}
      heliumSolution={{
