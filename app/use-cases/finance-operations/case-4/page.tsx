  ...
  return (
    <CaseDetail
      ...
      businessChallenge={{
        ...
        description: "Quarterly forecasts take 3 weeks to produce and are outdated within days. Static models miss 40% of market changes and trends, lead to $10M+ in missed opportunities or unexpected losses, provide limited scenario analysis (3-5 scenarios manually), lack real-time updates (quarterly refresh cycle), don't incorporate external factors (economic indicators, market data), require extensive manual data gathering and consolidation, and have limited collaboration across departments."
      }}
      heliumSolution={{
