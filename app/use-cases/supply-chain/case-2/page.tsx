  ...
  return (
    <CaseDetail
      ...
      businessChallenge={{
        ...
        description: "Supplier management involves 500+ suppliers, manual performance tracking, quarterly reviews (too infrequent), 20% of suppliers underperforming, and $10M+ in supplier-related costs. Supplier challenges include quality issues, delivery delays, pricing problems, limited visibility, and poor communication."
      }}
      heliumSolution={{
