  ...
  return (
    <CaseDetail
      ...
      businessChallenge={{
        ...
        challenges: [
          "Commission processing for 500+ agents takes 5-7 days monthly, with 10-15% error rate",
          "Agent disputes and dissatisfaction from inaccurate or delayed payments",
          "Manual calculations and reconciliation, delayed payments, and high administrative costs ($300K+ annually)",
          "Commission complexity includes multiple commission structures, override calculations, bonus and incentive programs, chargebacks and adjustments, and multi-level hierarchies"
        ]
      }}
      toolsUsed={[
        {
      ...
      comparisonTable={[
        {
          capability: "Automated Commission Calculation",
        ...
        {
          capability: "Agent Portal",
          popularTools: "Limited visibility",
          helium: true
        },
        {
          capability: "Automated Payment Processing",
          popularTools: "Manual payment generation",
          helium: true
        }
      ]}
      heliumSolution={{
