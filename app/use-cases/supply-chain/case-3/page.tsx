  ...
  return (
    <CaseDetail
      ...
      businessChallenge={{
        ...
        description: "Logistics network involves 50+ distribution centers, 200+ stores, complex routing, $25M+ annual logistics costs, and suboptimal network design. Network challenges include manual planning, limited optimization, poor visibility, high costs, and inflexibility."
      }}
      heliumSolution={{
